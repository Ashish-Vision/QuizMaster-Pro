...
| QM-029 automated tests             | Fixed foundation                  | Jest/Supertest/database/replica-set/Playwright suite                                                                          | 232 Jest and 28 Playwright checks; coverage limitations documented          |
